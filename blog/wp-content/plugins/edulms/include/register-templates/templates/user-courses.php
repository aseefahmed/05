        ...
        <figure class="img-thumbnail fig-<?php echo absint($post->ID);?>">
       		<?php 
				...
				if ( !is_user_logged_in() ) { 
					echo '<a class="cs-add-wishlist" data-toggle="modal" data-target="#myModal">';?> <?php _e('Add to Favourite','EDULMS');  echo '</a>';
			...
			<a class="blog-hover" <?php echo 'style="background-color:'.$course_subheader_bg_color.'"'; ?> href="<?php the_permalink();?>"><i></i></a>
        </figure>
